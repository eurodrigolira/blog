...
[![](images/04.png)](images/04.png)Porém quando não marcamos essa opção, precisamor configurar posteriormente no sistema, para isso siga os passos abaixo:

**1** - Acesse no menu **Edit** > **Preferences**, ou simplismente **Ctrl + P**.

[![](images/05.png)](images/05.png)**2** - Selecione **Updates**.

[![](images/06.png)](images/06.png)Vamos ver todas as opções:
...
[![](images/Connection-Settings-2019-03-15-12.13.11.png)](images/Connection-Settings-2019-03-15-12.13.11.png)
...
[![](images/08.png)](images/08.png)**4** - Agora clique em **Check for Updates**.

[![](images/09.png)](images/09.png)**5** - O software começa a verificação por atualizações.

[![](images/10.png)](images/10.png)**6** - Achando atualizações, as mesmas são exibidas, clique em **Download and Install** para baixar e instalação a versão atualizada.

[![](images/11.png)](images/11.png)**7** - O download é iniciado e podemos ver o progresso do mesmo.
...
[![](images/14-300x126.png)](images/14.png)Feche o **VMware Workstation Pro 15** e clique em **Next** novamente.
...
[![](images/15.png)](images/15.png)Pronto, VMware Workstation Pro 15 atualizado com sucesso.
