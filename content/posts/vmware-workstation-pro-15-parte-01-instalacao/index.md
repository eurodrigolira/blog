...
slug: "vmware-workstation-pro-15-parte-01-(instalação)"
date: 2019-01-08
categories: 
  - "virtualizacao"
tags: 
...
[![](images/01.png)](images/01.png)**02** - **Aceite os Termos** e clique em **Next**.

[![](images/02.png)](images/02.png)**03** - Selecione o **Enhanced Keyboard Driver** e clique em **Next**.

[![](images/03.png)](images/03.png)O  **Enhanced Keyboard Driver** oferece um melhor controle de teclados internacionais que possuem teclas extras. Esse recurso está disponível apenas para sistemas Windows.

**04** - Se deseja checar atualizações e participar do programa de experiência da VMware, selecione as opções e clique em **Next**.

[![](images/04.png)](images/04.png)**05** - Selecione para criar os ícones e clique em **Next**.

[![](images/05.png)](images/05.png)**06** - Clique em **Install**.

[![](images/06.png)](images/06.png)**07** - Clique em **License** e insira a sua licença, caso não possua licença, clique em **Finish**.

[![](images/07.png)](images/07.png)**08** - Insira a sua licença e clique em **Enter**.

[![](images/08.png)](images/08.png)**OBS:** Se você não possui a licença do VMware Workstation Pro, você pode usar o mesmo por um período de teste durante trinta dias.
...
[![](images/09.png)](images/09.png)Pode ser solicitado a reinicialização do sistema operacional, caso seja solicitado reinicie o sistema.
